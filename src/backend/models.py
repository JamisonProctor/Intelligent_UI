...
class UI_INSTRUCTIONS_FORMAT(BaseModel):
    ...
    ui_element_1_type: str = Field(description='Choose the most relevant UI element for the first element from this list: "TextInput", "Checkbox", "MultiSelect", "Slider", "SelectSlider". "Slider" or "SelectSlider" should only be used if the content is numerical and the numbers should be relvant to the topic. Think carefully! If the information is categorical, then "Checkbox" should be used.')
    ui_element_1_label: str = Field(description="A topically relevent label for the first UI element. Always add contextual Use emojis")
    ui_element_1_options: Optional[List[str]] = Field(description="A list of options considering the overview content for the first UI element, if applicable. Always add contextual emojis")
    ...
    ui_element_2_type: Optional[str] = Field(description='Choose the next most relevant UI element for the second element from this list: "TextInput", "Checkbox", "MultiSelect", "Slider", "SelectSlider", if applicable. "Slider" or "SelectSlider" should only be used if the content is numerical and the numbers should be relvant to the topic. Think carefully! If the information is categorical, then "Checkbox" should be used.')
    ui_element_2_label: Optional[str] = Field(description="A topically relevent label for the second UI element. Always add contextual Use emojis")
    ui_element_2_options: Optional[List[str]] = Field(description="A list of options considering the overview content for the second UI element, if applicable. Always add contextual emojis.")
    ...
    ui_element_3_type: Optional[str] = Field(description='Choose the next most relevant UI element for the third element from this list: "TextInput",  "Checkbox", "MultiSelect", "Slider", "SelectSlider", if applicable. "Slider" or "SelectSlider" should only be used if the content is numerical and the numbers should be relvant to the topic. Think carefully! If the information is categorical, then "Checkbox" should be used. Often a text input allowing the user to input whatever question they might have is the best choice here.')
    ui_element_3_label: Optional[str] = Field(description="A topically relevent label for the third UI element. Always add contextual Use emojis")
    ui_element_3_options: Optional[List[str]] = Field(description="A list of options considering the overview content for the third UI element, if applicable. Always add contextual emojis.")
...
class CONTENT_INSTRUCTIONS_FORMAT(BaseModel):
    ...
    ui_element_3_label: Optional [str] = Field(description="Refernce the content of the query. Offer a leading topic which will allow the reader to dive deeper into a specific aspect of the information, if applicable.")
    ...
    ui_element_3_type: Optional [str] = Field(description='Considering the options from above choose which UI element would be best from this list: "TextInput", "Button", "ListofButtons", "Checkbox", "MultiSelect", "Slider", "SelectSlider". "Slider" or "SelectSlider" should only be used for numerical content. If the information is categorical, then "Checkbox" should be used. Often a text input allowing the user to input whatever question they might have is the best choice here.')
